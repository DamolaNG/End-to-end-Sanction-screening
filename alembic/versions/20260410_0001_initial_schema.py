...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_raw_source_snapshot_source_system", "raw_source_snapshot", ["source_system"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("raw_source_snapshot.snapshot_id"),
            nullable=False,
        ),
        sa.Column("source_system", sa.String(length=50), nullable=False),
    ...
    op.create_index(
        "ix_raw_sanctions_record_source_system", "raw_sanctions_record", ["source_system"]
    )
    op.create_index(
        "ix_raw_sanctions_record_source_record_id", "raw_sanctions_record", ["source_record_id"]
    )
    ...
    op.create_index(
        "ix_raw_blackrock_fund_record_snapshot_id", "raw_blackrock_fund_record", ["snapshot_id"]
    )
    op.create_index(
        "ix_raw_blackrock_fund_record_source_record_id",
        "raw_blackrock_fund_record",
        ["source_record_id"],
    )
    op.create_index(
        "ix_raw_blackrock_fund_record_ingested_at", "raw_blackrock_fund_record", ["ingested_at"]
    )
    ...
    op.create_index(
        "ix_raw_blackrock_holding_record_snapshot_id",
        "raw_blackrock_holding_record",
        ["snapshot_id"],
    )
    op.create_index(
        "ix_raw_blackrock_holding_record_source_record_id",
        "raw_blackrock_holding_record",
        ["source_record_id"],
    )
    op.create_index(
        "ix_raw_blackrock_holding_record_ingested_at",
        "raw_blackrock_holding_record",
        ["ingested_at"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "run_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("screening_run.run_id"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_screening_match_sanctions_entity_id", "screening_match", ["sanctions_entity_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "match_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("screening_match.match_id"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_screening_match_evidence_match_id", "screening_match_evidence", ["match_id"]
    )
    op.create_index(
        "ix_screening_match_evidence_created_at", "screening_match_evidence", ["created_at"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_raw_blackrock_holding_record_ingested_at", table_name="raw_blackrock_holding_record"
    )
    op.drop_index(
        "ix_raw_blackrock_holding_record_source_record_id",
        table_name="raw_blackrock_holding_record",
    )
    op.drop_index(
        "ix_raw_blackrock_holding_record_snapshot_id", table_name="raw_blackrock_holding_record"
    )
    op.drop_table("raw_blackrock_holding_record")

    op.drop_index(
        "ix_raw_blackrock_fund_record_ingested_at", table_name="raw_blackrock_fund_record"
    )
    op.drop_index(
        "ix_raw_blackrock_fund_record_source_record_id", table_name="raw_blackrock_fund_record"
    )
    op.drop_index(
        "ix_raw_blackrock_fund_record_snapshot_id", table_name="raw_blackrock_fund_record"
    )
